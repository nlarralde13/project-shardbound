...
from engine.player_engine import Player  # type hints
from engine.actionRegistry import get_action

from engine.services import idempotency, cooldowns
from engine.services.rooms import for_player

from api.api.routes import _interactions

from engine.services import idempotency, cooldowns, rooms


# Import handlers so decorators run
from engine.actions import *  # noqa: F401,F403
...
# Replace with your real player accessor; consistent with api/api/routes.py singletons:
from api.api.routes import api_state as CURRENT_PLAYER, _interactions  # reuse the same player singleton
