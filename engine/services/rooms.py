# engine/services/rooms.py
"""
Room service adapters
- Delegates to engine.world_loader so all callers share the same cached Room objects.
- Provides convenience helpers for getting the player's current room.
"""

from __future__ import annotations
from typing import Tuple
from engine.world_loader import get_room_by_id, get_room, _CURRENT_WORLD  # type: ignore[attr-defined]
